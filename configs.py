...
class Config(object):
	...
	OWNER_ID = int(os.environ.get("OWNER_ID", 501197185))
	CAPTION = "By @AHToolsBot"
	BOT_USERNAME = os.environ.get("BOT_USERNAME", "ZZ_WaterMarkbot")
...
__Note: I can only process one video at a time. As my server is Heroku, my health is not good. If you have any issues with Adding Watermark to a Video, then please Report at [Support Bot](https://t.me/ZZ_supBot).__

Desgined by @ERROR_BUG
"""
	PROGRESS = """
Percentage : {0}%
Done ✅: {1}
